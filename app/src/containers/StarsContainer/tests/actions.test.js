...
describe('StarsContainer actions', () => {
  it('should have a type of STARSCONTAINER/LOAD_DATA_INITIATION', () => {
    const expected = {
      type: T.LOAD_DATA_INITIATION,
    };
    expect(A.loadDataInitiation()).toEqual(expected);
  });
  it('should have a type of STARSCONTAINER/LOAD_DATA_SUCCESS', () => {
    const expected = {
      type: T.LOAD_DATA_SUCCESS,
    };
    expect(A.loadDataSuccess()).toEqual(expected);
  });
  it('should have a type of STARSCONTAINER/LOAD_DATA_FAILURE', () => {
